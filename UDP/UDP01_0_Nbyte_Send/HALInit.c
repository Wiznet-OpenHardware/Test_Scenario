...
void gpioInitialize(void)
{
	...
	GPIO_PinAFConfig(PRINTF_USART_TX_PORT, GPIO_PinSource9, GPIO_AF_USART1);
	GPIO_PinAFConfig(PRINTF_USART_RX_PORT, GPIO_PinSource10, GPIO_AF_USART1);
	...
	RCC_AHB1PeriphClockCmd(W5100S_GPIO_RCC, ENABLE);

	/*For SPI*/
	GPIO_PinAFConfig(W5100S_SPI_PORT, GPIO_PinSource3, GPIO_AF_SPI1);
	GPIO_PinAFConfig(W5100S_SPI_PORT, GPIO_PinSource4, GPIO_AF_SPI1);
	GPIO_PinAFConfig(W5100S_SPI_PORT, GPIO_PinSource5, GPIO_AF_SPI1);
	...
	GPIO_Init(SPI_ENABLE_Port, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStructure.GPIO_Pin = SPI_SEL1_Pin;
	GPIO_Init(SPI_SEL_Port, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStructure.GPIO_Pin = SPI_SEL0_Pin;
	GPIO_Init(SPI_SEL_Port, &GPIO_InitStructure);
...
void spiInitailize(void)
{
	...
	RCC_APB2PeriphClockCmd(W5100S_SPI_RCC, ENABLE);
